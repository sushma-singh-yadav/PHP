...
<div class="row">
<div class="col-md-6">
<select class="form-control" name="category" id="selectoption" onchange="getsubcategory(this.value);">
...
<div class="col-md-6">
<select class="form-control" name="subcategory[]" id="subselectoption" multiple="multiple">
</select>
</div>
</div>
